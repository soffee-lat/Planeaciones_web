...
/**
 * Actualiza campos pedagógicos editables de una PlanningRequest en BORRADOR e
 * incrementa `input_revision` únicamente cuando al menos un campo trackeado
 * cambia realmente. El formato de exportación no forma parte de este input.
 */
