        ...
        $definitions = [
            'generation' => [
                ...
                'body' => implode("\n", [
                    ...
                    'La calibración por nivel y grado es obligatoria cuando INPUT.pedagogical_stage exista:',
                    '- respeta educational_level, grade_name, complexity_band, planning_guardrails, avoid y assessment_emphasis;',
                    '- complexity_band es una heurística interna de progresión, no una escala oficial ni un límite rígido;',
                    '- el PDA seleccionado, el perfil real del grupo y el contexto tienen prioridad sobre cualquier heurística;',
                    '- en preescolar prioriza juego, exploración, oralidad, movimiento, interacción, lenguajes artísticos y materiales concretos según el grado;',
                    ...
                    '- cada bloque con primary_topics debe desarrollar esos temas como foco principal de esa área o materia;',
                    '- no inventes un tema principal diferente para un área o materia que ya tiene primary_topics asignados;',
                    ...
                    '- en un bloque transversal no inventes un tema principal nuevo sólo para llenar el área o materia;',
                    '- no fuerces conexiones artificiales: si una transversalidad no aporta, conserva la identidad del área o materia y realiza un refuerzo sencillo y pertinente;',
                    '- integrative_project es un contexto común opcional; nunca sustituye los temas propios de cada área o materia;',
            ...
            'audit' => [
                ...
                'body' => implode("\n", [
                    'Audita la planeación CANONICAL contra su currículo congelado, su perfil de grupo y su calibración pedagógica.',
                    'Si CANONICAL.context.pedagogical_stage existe, úsalo para valorar adecuación al nivel y grado:',
                    '- no trates complexity_band como escala oficial ni como límite rígido;',
                    '- el PDA, el contexto y el perfil real del grupo prevalecen;',
                    '- marca PEDAGOGICAL_ALIGNMENT cuando una actividad o evidencia exija habilidades claramente no sustentadas por el PDA/nivel/grado o contradiga los guardrails;',
                    '- en preescolar vigila especialmente escolarización prematura, escritura convencional impuesta, exposición prolongada y evaluación centrada sólo en productos;',
                    '- en primaria calibra la progresión por grado sin exigir tareas de secundaria o de personas adultas;',
                    '- no generes hallazgos sólo porque una actividad sea sencilla: debe existir una desalineación concreta y explicable.',
            ...
            'correction' => [
                ...
                'body' => implode("\n", [
                    'Corrige únicamente el alcance autorizado y los hallazgos de AUDIT.',
                    'Conserva la calibración de CANONICAL.context.pedagogical_stage:',
                    '- respeta nivel, grado, PDA, perfil del grupo y guardrails;',
                    '- no aumentes o reduzcas artificialmente la dificultad sólo por la banda interna;',
                    '- para preescolar conserva juego, exploración, oralidad, movimiento y evidencias apropiadas;',
                    '- para primaria ajusta autonomía y complejidad al grado sin convertir la experiencia en trabajo de secundaria/adultos.',
                    'CANONICAL={{canonical_plan}}',
                    'AUDIT={{audit_report}}',
                    'SCOPE={{section_keys}}',
                    'OUTPUT={{output_schema}}',
