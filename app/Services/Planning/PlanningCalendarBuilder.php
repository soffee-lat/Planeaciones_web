    ...
    public function build(GroupSchedule $schedule, CarbonInterface|string $startsOn, CarbonInterface|string $endsOn): array
    {
        ...
        return [
            ...
            'rules' => [
                ...
                'daily_session_minutes_must_equal_planeable_minutes' => true,
                'sessions_must_fit_planeable_blocks_in_chronological_order' => true,
                'scheduled_field_codes_must_be_respected_when_present' => true,
